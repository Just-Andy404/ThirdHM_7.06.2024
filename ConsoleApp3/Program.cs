/*
 Создайте приложение "Список книг к прочтению". Приложение
должно позволять добавлять книги в список, удалять книги
из списка, проверять есть ли книга в списке, и т.д. Используйте механизм свойств, нагрузки операторов,
индексаторов. 
 */
